...
# Example usage
datasetDividor(r"./DatasetGenerator/GeneratingSyntheticLogDatas/twohundredtousands/hospital_access_logs", 200000, r"./DatasetGenerator/GeneratingSyntheticLogDatas/twohundredtousands/train/Train.csv", r"./DatasetGenerator/GeneratingSyntheticLogDatas/twohundredtousands/test/Test.csv")