...
df = pd.read_csv(r"./GeneratingSyntheticLogDatas/SecondTry/CV.csv")
...
num_to_select = min(2, len(unique_ids))
...
df.to_csv(r"./GeneratingSyntheticLogDatas/SecondTry/Final/CV.csv", index=False)
print("Updated!")
